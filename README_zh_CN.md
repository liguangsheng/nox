...
Nox 当前最新正式发布版本是 `v0.0.5`。该版本的 Cargo 版本、git tag、CHANGELOG、
...
- `nox-cli-v0.0.5-x86_64-unknown-linux-gnu.tar.gz`：面向终端用户，包含 `bin/nox`、
  README、CHANGELOG 和脚本示例。
- `nox-embed-v0.0.5-x86_64-unknown-linux-gnu.tar.gz`：面向宿主应用，包含
